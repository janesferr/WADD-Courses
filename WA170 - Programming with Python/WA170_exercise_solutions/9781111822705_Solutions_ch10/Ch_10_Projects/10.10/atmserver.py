...
Modified to run as an ATM server from a manager's application.  The call
of main() has been disabled, as have the outputs of the server to the terminal.
These outputs could be logged in a list instead.
...
# main()   Commented for Project 10.10
